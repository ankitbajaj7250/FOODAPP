...
import com.example.foodapp.adapter.History_adapter
...
class Frag_history :Fragment() {
    ...
    private var orderHistoryList = ArrayList<descriptionOrder>()
                    ...
                    if (success) {
                        ...
                        if (resArray.length() == 0) {
                            ...
                            for (i in 0 until resArray.length()) {
                                ...
                                val orderDetails = descriptionOrder(
                                ...
                                if (orderHistoryList.isEmpty()) {
                                    ...
                                    if (activity != null) {
                                        ...
                                        recyclerOrderHistory.adapter = historyAdapter
                                    } else {
